do
    ...
    local function checkForBadThoughts()
        ...
        if df.unit_thought_type[mostPopularNegativeThought.thought_type] then
            write_gamelog_and_announce('Your people are most complaining about this: "' .. df.unit_thought_type.attrs[mostPopularNegativeThought.thought_type].caption..'".',COLOR_CYAN)
        end
    end
    checkForBadThoughts()
end