-- Add a syndrome to units withing los of another, removing its intelligence tags
--[[

	usage succubus/fovununsentient <sourceUnit> <creatureRaw>
...
function doAffect(unit)
	dfhack.run_script('addsyndrome2', 'SYNDROME_UNSENTIENT', unit.id)
end
